...
interface TaskFileCellProps {
  hasAttachment: boolean;
  onAddAttachment: (e: React.MouseEvent) => void;
}

const TaskFileCell: React.FC<TaskFileCellProps> = ({ hasAttachment, onAddAttachment }) => (
