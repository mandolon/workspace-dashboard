...
import { Plus, Edit, Check, X, MoreHorizontal } from 'lucide-react';
...
const TaskRow = ({
  ...
  const handleDeleteTask = () => {
    ...
    // This will be implemented to soft delete the task
  };
    ...
    <ContextMenu>
      ...
      <ContextMenuContent>
        ...
        <ContextMenuItem onClick={handleDuplicateTask}>
          <div className="w-4 h-4 mr-2" /> {/* Spacer for duplicate icon */}
          Duplicate
        </ContextMenuItem>
        <ContextMenuSeparator />
        <ContextMenuItem onClick={handleDeleteTask} className="text-red-600">
          <div className="w-4 h-4 mr-2" /> {/* Spacer for delete icon */}
          Delete
        </ContextMenuItem>
      </ContextMenuContent>
    </ContextMenu>
