      ...
      <Table>
        <TableHeader>
          <TableRow className="border-b border-border transition-colors hover:bg-accent/50 group">
            <TableHead className="text-muted-foreground font-medium text-xs py-1.5 h-auto align-baseline w-[50%] sm:w-[36%] pl-8 transition-colors group-hover:bg-accent/50 hover:bg-accent cursor-pointer">
              Name
            </TableHead>
            ...
            <TableHead className="text-muted-foreground font-medium text-xs py-1.5 h-auto align-baseline w-[9%] transition-colors group-hover:bg-accent/50 hover:bg-accent cursor-pointer">
            ...
            {/* Created by */}
            <TableHead className="text-muted-foreground font-medium text-xs py-1.5 h-auto align-baseline w-[8%] transition-colors group-hover:bg-accent/50 hover:bg-accent">
              Created by
            </TableHead>
